...
namespace IronBoots.Data.Migrations
{
    ...
    [Migration("20241211174234_RemovedPlannedAssignedDate")]
    partial class RemovedPlannedAssignedDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IronBoots.Data.Models.Product", b =>
                {
                    ...
                    b.Property<decimal>("Price")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasComment("Market price of the product");
            ...
            modelBuilder.Entity("IronBoots.Data.Models.Vehicle", b =>
                {
                    ...
                    b.Property<bool>("IsAvailable")
                        .HasColumnType("bit")
                        .HasComment("Check if the vehicle is currently available");
            ...
            modelBuilder.Entity("IronBoots.Data.Models.Shipment", b =>
                {
                    b.HasOne("IronBoots.Data.Models.Vehicle", "Vehicle")
                        .WithOne("Shipment")
                        .HasForeignKey("IronBoots.Data.Models.Shipment", "VehicleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
